...
##Problem 2
Specifying the sheet in excel that needs to be read is Mr. Trash Wheel. Omitted rows with notes, figures, and columns containing notes as well as columns that did not include dumpster specific data.
```{r}
Mr_Trash_Wheel=
